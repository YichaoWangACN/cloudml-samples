...
CSV_COLUMNS = ['consumer_id', 'exact_age', 'length_of_residence', 'num_adults',
               ...
               'num_adults_range', 'length_of_residence_range']
CSV_COLUMN_DEFAULTS = [[''], [0.0], [0.0], [0.0], [''], [''], [''], [''], [''], [''],
                       [''], [''], [''], [''], ['']]
LABEL_COLUMN = 'dwell_type'
LABELS = ['0','30','50','60','80']
# LABELS = ['A','M']
...
def build_estimator(config, embedding_size=8, hidden_units=None):
  ...
  """
  (gender, homeowner, pres_kids, hh_marital_status, metro_nonmetro, urban_rural_flag,
